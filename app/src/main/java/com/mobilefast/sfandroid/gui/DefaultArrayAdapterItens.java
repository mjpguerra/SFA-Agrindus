...
public class DefaultArrayAdapterItens extends ArrayAdapter<DefaultListModel>
    ...
    public void initControles(LinearLayout v1, int position) {
        ...
        btImagemProd.setOnClickListener(v -> {
        ...
        btInfo.setOnClickListener(v -> detalheProduto(v));
    ...
    public void detalheProduto(View v) {
        ...
        ld.setPadding(5,5,5,5);
        //ld.setBackgroundDrawable(shapeback);
        ld.setBackgroundColor(getContext().getResources().getColor(R.color.background));
