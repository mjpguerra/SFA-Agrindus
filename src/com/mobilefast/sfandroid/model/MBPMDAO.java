...
public class MBPMDAO {
   ...
   public void somarOffset() {offset = offset + 18;}
   public void open(){	db = dBHelper.getWritableDatabase();} 
   public void close(){db.close();} 
   public String getPath(){this.open();return db.getPath();} 
   public boolean deletar(long id){this.open();boolean b = db.delete("MBPM", "R_E_C_N_O_ ="  + id, null) > 0;this.close();return b;}
   private MBPMDAO(){dBHelper = new DatabaseHelper(ControllerSFAndroid.getInstancia().getContext());}
