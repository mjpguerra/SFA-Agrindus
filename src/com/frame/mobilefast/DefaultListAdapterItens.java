...
public class DefaultListAdapterItens extends ArrayAdapter<DefaultListModel>
{
  ...
  public DefaultListAdapterItens(Context context, int textViewResourceId, List<DefaultListModel> lista)
  {
  ...
  public View getView(int position, View convertView, ViewGroup parent)
  {
    ...
    if (convertView == null)
    {
      ...
      nomeValor.setText(o.getDescricao());
